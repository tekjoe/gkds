    ...
    <div class="features">
      <div class="feature">
        <div class="feature__image">
          ...
          <img loading="lazy" src="<?php echo get_template_directory_uri() . '/images/'; ?>adults_dancing.png" alt="" />
        </div>
      ...
      <div class="feature feature--reverse">
        <div class="feature__image">
          <div class="image-overlay"></div>
          <img loading="lazy" src="<?php echo get_template_directory_uri() . '/images/'; ?>single_adult_dancing.png"
            alt="" />
        </div>
        <div class="feature__content">
      ...
      <div class="feature">
        <div class="feature__image">
          <div class="image-overlay"></div>
          <img loading="lazy"
            src="<?php echo get_template_directory_uri() . '/images/home-page/'; ?>baila_milwaukee.jpg" alt="" />
        </div>
        <div class="feature__content">
    ...
    <div class="staff">
      <div class="staff__flex">
        <div class="staff__member">
          ...
          <img loading="lazy" src="<?php echo get_template_directory_uri() . '/images/home-page/'; ?>krystal_nicola.jpg"
            alt="Krystal Nicola" />
        </div>
        <div class="staff__member">
          <div class="staff__overlay">
          ...
          <img loading="lazy" src="<?php echo get_template_directory_uri() . '/images/home-page/'; ?>gustavo_nicola.jpg"
            alt="Gustavo Nicola" />
        </div>
